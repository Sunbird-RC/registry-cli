	...
	getDocumentTypeReq() {
		return {
			...
			samples: [
				{
					schemaUrl:
						'https://raw.githubusercontent.com/Sunbird-RC/demo-certificate-issuance/main/schemas/SkillCertificate.json',
					certificateUrl:
						'https://raw.githubusercontent.com/Sunbird-RC/demo-certificate-issuance/main/schemas/templates/SkillCertificate.html',
					thumbnailUrl:
						'https://avatars.githubusercontent.com/u/81144329?s=200&v=4',
				},
			],
		}
	}
